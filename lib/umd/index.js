(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('bbmn-core'), require('backbone.marionette')) :
	typeof define === 'function' && define.amd ? define(['exports', 'bbmn-core', 'backbone.marionette'], factory) :
	(factory((global.bbmn = global.bbmn || {}, global.bbmn.utils = {}),global.bbmn,global.Mn));
}(this, (function (exports,bbmnCore,Mn) { 'use strict';
...
function traverse(fields, root) {
	...
	var hash = bbmnCore.isModel(this) ? this.attributes : this;
...
function getProperty(context, name) {
	...
	if (bbmnCore.isModel(context)) return context.get(name, { gettingByPath: true });else return context[name];
}
...
function mix(_ctor, options) {
	...
	if (!_.isFunction(ctor.extend)) ctor.extend = bbmnCore.extend;
...
function buildViewByKey(key) {
	...
	if (bbmnCore.isView(view)) {
		return view;
	} else if (bbmnCore.isViewClass(view)) {
...
exports.mergeObjects = mergeObject;
